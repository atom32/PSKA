...
- Knowledge Base 详情页已按产品心智收敛为 `资料 / Ask / 处理 / Digest / 设置` tabs：复用真实导入、文档 lifecycle、证据搜索、chunk preview、高级同步、Digest 日志和 Prompt Profile/KB 管理入口，避免资料库工作台继续平铺成一长页。
