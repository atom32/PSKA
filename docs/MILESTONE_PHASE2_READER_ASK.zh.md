...
- Knowledge Base `Ask` tab 已增加当前 KB scoped Ask 历史：复用真实 Ask conversations 的 `scope_applied/knowledge_base_ids`，展示当前 KB 的最近对话、强限定数量和最近提问时间，并可直接跳回 Today 继续该对话。
